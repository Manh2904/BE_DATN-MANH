          ...
          <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
              ...
              <div class="form-group"><label class="font-normal">Trạng thái</label>
                <div><label> <input type="radio" checked="" value="1" id="optionsRadios1" name="optionsRadios"> Hoạt
                        động</label></div>
                <div><label> <input type="radio" value="0" id="optionsRadios2" name="optionsRadios"> Không hoạt
                        động</label></div>
              </div>
            </div>
          </div>
