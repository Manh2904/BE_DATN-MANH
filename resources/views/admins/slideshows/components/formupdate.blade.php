          ...
          <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
              ...
              <div class="form-group"><label class="font-normal">Trạng thái</label>
                <div class="row">
                  <div class="col-sm-5">
                    <div><label> <input type="radio" {{$slideShowDetail->active == 1 ? 'checked' : ''}} value="1" name="optionsRadios"> Hoạt
                      động</label></div>
              <div><label> <input type="radio" {{$slideShowDetail->active == 0 ? 'checked' : ''}} value="0" name="optionsRadios"> Không hoạt
                      động</label></div>
                  </div>
                  <div class="col-sm-7">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div style="display: flex; align-items: center">
                          ...
                          <input type="number" min="100" max="600" class="form-check-input form-control" value="{{$slideShowDetail->speed}}" style="height: 25px; margin-left: 2px; font-size: 12px" name="speed">
                        </div>
                      </div>
                    </div>
                  </div>
