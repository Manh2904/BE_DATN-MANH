        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                        <img alt="image" style="width: 48px; aspect-ratio: 1/1; object-fit: cover;" class="img-circle" src="storage/uploads/khachhang/7ZC1nGCWo9ytJgQ1NOkLZvon7sVtRFvKnayaaTTA.jpg">
                    </span>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Cao Văn Mạnh</strong>
